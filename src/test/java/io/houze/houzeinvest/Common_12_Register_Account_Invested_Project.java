...
public class Common_12_Register_Account_Invested_Project extends AbstractTest {
    ...
    @BeforeTest(groups = "smoke", description = "Register an account with invested project")
